...
const HERO_OFFSET_MOBILE = 56;
const HERO_OFFSET_DESKTOP = 72;
...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      style={{
        marginTop: `${HERO_OFFSET_MOBILE}px`,
        height: `calc(100vh - ${HERO_OFFSET_MOBILE}px)`,
      }}
    >
      <div
      ...
      <div
        ...
        style={{
          height: `calc(100vh - ${HERO_OFFSET_DESKTOP}px)`,
        }}
      >
        <AnimatePresence mode="wait">
          <motion.div
